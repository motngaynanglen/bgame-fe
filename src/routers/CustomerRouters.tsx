 ...
 *
 */
export const customerMenuAntd: ItemType<MenuItemType>[] | undefined = [
    {
        key: "default",
        label: (<Link href={"/staff"} className={clsx("font-medium text-base")}>Bảng thống kê</Link>),
        icon: (
            <svg
    ...
    },
    {
        ...
        key: 'group-1',
        label: (
            <p className="mb-4 ml-4 text-xl font-semibold text-bodydark2">
                Thư mục quản lý
            </p>
        ),
    },
    ...
    },
    {
        ...
        children: [
            ...
            {
                key: '23', label: (<Link href={"/staff/users"}
                    className={clsx("font-medium text-base")}>Quản lý người dùng</Link>),
                icon: (<UserOutlined />),
            },
...
export const customerRouter: DashboardRouter = {
    role: "customer",
    route: customerMenuAntd,
}
