...
export const ManagerMenuAntd: ItemType<MenuItemType>[] | undefined = [
	{
		key: "default",
		label: (<Link href={"/manager"} className={clsx("font-medium text-base")}>Bảng thống kê</Link>),
		icon: (
			<svg
				className="fill-current"
				width="18"
	...
	{
		key: "group-12",
		label: (<Link href={"/manager/boardgames"} className={clsx("font-medium")}>Quản lý trò chơi</Link>),
		icon: (<ReconciliationOutlined />),
	},
	{
		key: "group-13",
	...
	{
		key: "group-14",
		label: (<Link href={"/manager/table"} className={clsx("font-medium")}>Quản lý Bàn</Link>),
		icon: (<UserOutlined />),
	},
