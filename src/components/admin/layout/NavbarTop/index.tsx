		...
		<>
			<div className="flex flex-grow items-center justify-between shadow-2 ">
				<div className="flex items-center gap-2 sm:gap-4 ">
					...
					<Button
						type="text"
						icon={props.sidebarOpen ? <MenuUnfoldOutlined style={{fontSize:"26px"}}/> : <MenuFoldOutlined  style={{fontSize:"26px"}}/>}
				...
				<div className="flex items-center gap-3 2xsm:gap-7 pe-5">
